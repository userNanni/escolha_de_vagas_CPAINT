...
export function ControllerTable({
  ...
  const handleOptimisticUpdate = useCallback(
    (id: number, field: keyof Pessoa, value: string | number | boolean) => {
      const key = `${id}-${field}`;
  ...
  const handleLocalidadeChange = useCallback(
  ...
  const getOptimisticValue = useCallback(
    (id: number, field: keyof Pessoa, originalValue: any) => {
      const key = `${id}-${field}`;
    ...
    () => [
        ...
        cell: ({ row }) => {
          ...
          return (
            <DebouncedInput
              ...
              onUpdate={(value) =>
                handleOptimisticUpdate(row.original.id, "classificacao", value)
              }
              className="w-20"
              disabled={isUpdating}
              delay={300}
        ...
        cell: ({ row }) => {
          ...
          return (
            <DebouncedInput
              ...
              defaultValue={optimisticValue}
              onUpdate={(value) =>
                handleOptimisticUpdate(row.original.id, "nome", value)
              }
        ...
        cell: ({ row }) => {
          ...
          return (
            <OptimizedSelect
              ...
              onUpdate={(value) =>
                handleLocalidadeChange(row.original.id, value)
              }
              disabled={isUpdating}
            />
          );
      ...
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <span className="text-sm text-slate-600">{optimisticValue}</span>
          );
        },
      },
      {
        ...
        cell: ({ row }) => {
          ...
          return (
            <OptimizedCheckbox
              ...
              onUpdate={(value) =>
                handleOptimisticUpdate(row.original.id, "show_card", value)
              }
              disabled={isUpdating}
            />
          );
        ...
        cell: ({ row }) => {
          ...
          return (
            <OptimizedCheckbox
              checked={optimisticValue}
              onUpdate={(value) =>
                handleOptimisticUpdate(row.original.id, "show_om", value)
              }
              disabled={isUpdating}
            />
          );
        ...
        cell: ({ row }) => {
          ...
          return (
            <OptimizedCheckbox
              checked={optimisticValue}
              onUpdate={(value) =>
                handleOptimisticUpdate(row.original.id, "hide_card", value)
              }
              disabled={isUpdating}
            />
          );
        ...
        <TableBody>
          {table.getRowModel().rows?.length ? (
            table.getRowModel().rows.map((row) => {
              const isUpdating = row.original.id === updatingId;
              const hasPendingUpdates = Array.from(pendingUpdates.keys()).some(
                (key) => key.startsWith(`${row.original.id}-`)
              );
